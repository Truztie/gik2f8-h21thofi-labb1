const BookDetail = (book, x, y) => {
    ...
    let bookDetail = `<div id="BookDetail" class="book-item__detail flex bg-slate-600 text-slate-200 w-auto absolute rounded-md border-2 border-slate-900 p-4 w-full mx-auto top-[${y}px] left-[${x}px]">
